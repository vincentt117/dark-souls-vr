 ...
 */
public class Rectangle implements ARDrawable {
    ...
    public Rectangle(float size, float x, float y, float z) {
    ...
    private void setArrays(float size, float x, float y, float z) {
         ...
         */
        float vertices[] = {
                x - hs, y - hs - 10.0f, z - 5.0f, // 0 --> If you look at the cube from the front, this is the corner
                // in the front on the left of the ground plane.
                x + hs, y - hs - 10.0f, z - 5.0f, // 1 --> That is the one to the right of corner 0
                ...
                x - hs, y - hs - 10.0f, z + 5.0f, // 4 --> That is the top left corner. Directly on top of 0
                x + hs, y - hs - 10.0f, z + 5.0f, // 5 --> That is directly on top of 1
